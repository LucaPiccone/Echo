...
export default async function Echo() {
    // Verify the session MIDDLE WARE NOW DOES THIS.
                ...
                <div className="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    >
                        <div style={{
                            ...
                            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)]"
                        />
                        </div>
                    </div>
                </div>
